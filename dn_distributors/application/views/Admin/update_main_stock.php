...
<div class="container modal fade" style="padding-top: 20px" id="updateMainStockModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" id="form">
                    ...
                    <div class="row" style="padding-top: 8px">
                        <div class="col-md-3">
                            <label for="stock_quantity" style="color: grey">Adding Quantity</label>
                        </div>
                        <div class="col-md-7">
...
<script type="text/javascript">
    ...
    function edit_main_stock(stock_id){
        save_method = 'update';
        $.ajax({
            url: "<?php echo site_url(); ?>/Admin/update_each_main_stock/" + stock_id,
            type: "GET",
            dataType: "JSON",
            success: function(data){
                ...
                $('#updateMainStockModal').modal('show');
            }
        })
    }
    ...
    function save(){
        $.ajax({
            url: "<?php echo site_url(); ?>/Admin/update_main_stock_details",
            type: "POST",
            data: $('#form'). serialize(),
            dataType: "JSON",
            success: function(data){
                $('#updateMainStockModal').modal('hide');
                location.reload();
            },
    ...
    function load_data(query){
        $.ajax({
            url: "<?php echo site_url(); ?>/Admin/search_update_main_stock",
            type: "POST",
            data: {query:query},
            success: function(data){
                $('#result').html(data);
